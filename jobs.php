        ...
        <div class="col-md-9">
          <div style=" margin-top: 30px; padding-left: 50px;">
            ...
            <form class="example" action="jobs.php">
              <input style="color:#000; height:45px; width:700px; border-radius:30px 0px 0px 30px;" type="text" placeholder="     Search For Jobs.." name="q">
              <button type="submit" style="height:45px; width:130px; border-radius:0px 30px 30px 0px; background-color: #257059; "><i class="fa fa-search bb"></i></button>
            </form>
          </div>
            ...
            <div class="row">
              ...
              ?>
                  ...
                  <div class="col-md-4 crd" style="margin: 20px; background-color:#257059; padding: 20px;">
                    ...
                    <!-- ------------------------------------------------------------------ -->
                    <a href="#" class="pull-right apply-btn" data-jobid="<?php echo $pid; ?>" data-ename="<?php echo $ename; ?>" style="font-family: 'Sora', sans-serif; color:#e9c46a;">
...
<script>
  ...
  function applyForJob(jobId, companyName) {
    // Display a confirmation dialog
    var confirmApply = confirm("Are you sure you want to apply for this job at " + companyName + "? Your resume will be sent to the company.");

    // If the user confirms, redirect to the applyJob.php page
    if (confirmApply) {
      window.location.href = "applyJob.php?id=" + jobId;
    }
  }

  // Add click event listeners to all elements with the class 'apply-btn'
  document.querySelectorAll('.apply-btn').forEach(function (element) {
    element.addEventListener('click', function (event) {
      event.preventDefault(); // Prevent the default behavior of the link
      var jobId = this.getAttribute('data-jobid');
      var companyName = this.getAttribute('data-ename');
      applyForJob(jobId, companyName);
    });
  });
</script>
