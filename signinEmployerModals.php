  ...
  <div class="modal-dialog" role="document">
    ...
    <div id="menu1" class="tab-pane fade"  style="width: 50%;">
      ...
      <form class="cd-form" method="post" action="registerJobseeker.php" enctype="multipart/form-data">
          ...
          <p class="fieldset" style="padding-right: 30px;">
          <label  for="resume" style="color: white; font-size: 15px;">Resume</label>
                        <label class="image-replace cd-username" for="empsignup-username">Resume (PDF or Word)</label>
                        <input class="full-width has-padding has-border" id="resume" name="resume" type="file" placeholder="Resume (PDF or Word)"   style="background-color: white;">
                    </p>
                   
                                       
					<p class="form-group" style="padding-top:20px">
                                            <button id="regsubmit" class="full-width has-padding btn-success" style="padding:10px; background-color: #e9c46a;color:#1d3557;">Create account</button>
					</p>
