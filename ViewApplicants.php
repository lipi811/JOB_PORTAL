    ...
    <div class="container-fluid" style="background-color: #a0c4ff; padding-left: 50px; padding-right: 50px;">
        ...
        <div class="hero">
            ...
            <div style="width: 100%; padding-left: 50px; padding-right: 50px; " class="row">
                ...
                <div style=" height: 100vh; padding-top: 0px; " class="col-md-12">
                    ...
                    <table class="table table-hover table-responsive table-striped" id='jobappliedTable'>
                        ...
                        <tbody>
                            ...
                            <?php
                          $sql = "SELECT j.id, j.sid, j.pid, s.name AS sname, j.date,
                          p.name AS title, s.skills, s.resume AS resume, j.status
                          FROM jobsapplied j
                          JOIN seeker s ON j.sid = s.id
                          JOIN post p ON j.pid = p.id
                          WHERE p.eid = $eid";
               ...
               <?php
               if (!empty($resume)) {
                 //  echo 'Resume URL: ' . $resume; // Debug statement
               ...
               ?>
                                        ...
                                        <td>
        <a href="acceptApplication.php?id=<?php echo $id; ?>" class="btn btn-success">Accept</a>
        <a href="rejectApplication.php?id=<?php echo $id; ?>" class="btn btn-danger">Reject</a>
    </td>
                                    </tr>
                            <?php
                                }
